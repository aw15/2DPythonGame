...
roadComboBox = ttk.Combobox(tab2)
roadComboBox['values'] = ('서울', '인천', '강원도', '충청도', '전라도','경상도')
roadComboBox.grid(column=1, row=0)
roadButton = Button(tab2, font = buttonFont , text = "검색",command=bycicleProcess)
roadButton.grid(column=2, row=0)


photo = PhotoImage(file="SearchMap.gif")
roadImage =Label(tab2)
